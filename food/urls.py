...
from food.views import IngredientListView, IngredientCreateView, IngredientDetailView, IngredientUpdateView, IngredientDeleteView, ingredient_manage, dish_amounts_form, meal_portions_form, dish_multiply, dish_duplicate, meal_duplicate, MealMonthArchiveView, MealWeekArchiveView, MealDayArchiveView
