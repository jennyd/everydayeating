...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comestible.dishiness'
        db.add_column('food_comestible', 'dishiness',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Comestible.dishiness'
        db.delete_column('food_comestible', 'dishiness')
    ...
    models = {
        ...
        'food.comestible': {
            ...
            'dishiness': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
