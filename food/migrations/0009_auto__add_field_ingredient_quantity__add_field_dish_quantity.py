...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ingredient.quantity'
        db.add_column('food_ingredient', 'quantity', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=6, decimal_places=2), keep_default=False)

        # Adding field 'Dish.quantity'
        db.add_column('food_dish', 'quantity', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ingredient.quantity'
        db.delete_column('food_ingredient', 'quantity')

        # Deleting field 'Dish.quantity'
        db.delete_column('food_dish', 'quantity')
