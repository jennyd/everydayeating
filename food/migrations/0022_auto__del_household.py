...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('food_household')

    def backwards(self, orm):
        # Adding model 'Household'
        db.create_table('food_household', (
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='is_admin', to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('food', ['Household'])
