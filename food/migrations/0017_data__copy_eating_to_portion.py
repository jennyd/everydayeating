...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for eating in orm.Eating.objects.all():
            portion = orm.Portion.objects.create(
                comestible = eating.comestible,
                meal = eating.meal,
    ...
    def backwards(self, orm):
        ...
        for portion in orm.Portion.objects.all():
            eating = orm.Eating.objects.create(
                comestible = portion.comestible,
                meal = portion.meal,
