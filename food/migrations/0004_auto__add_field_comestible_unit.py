...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comestible.unit'
        db.add_column('food_comestible', 'unit', self.gf('django.db.models.fields.CharField')(default='g', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comestible.unit'
        db.delete_column('food_comestible', 'unit')
