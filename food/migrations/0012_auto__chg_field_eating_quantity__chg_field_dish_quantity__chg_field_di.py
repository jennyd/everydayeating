...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Eating.quantity'
        db.alter_column('food_eating', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Dish.quantity'
        db.alter_column('food_dish', 'quantity', self.gf('django.db.models.fields.DecimalField')(default=500, max_digits=6, decimal_places=2))

        # Changing field 'Dish.total_quantity'
        db.alter_column('food_dish', 'total_quantity', self.gf('django.db.models.fields.DecimalField')(default=500, max_digits=6, decimal_places=2))

        # Changing field 'Amount.quantity'
        db.alter_column('food_amount', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
    models = {
        'food.amount': {
        ...
        'food.dish': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '500', 'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'total_quantity': ('django.db.models.fields.DecimalField', [], {'default': '500', 'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'})
        },
        'food.eating': {
        ...
        'food.ingredient': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '100', 'max_digits': '6', 'decimal_places': '2'}),
