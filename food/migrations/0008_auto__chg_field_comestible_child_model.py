...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comestible.child_model'
        db.alter_column('food_comestible', 'child_model', self.gf('django.db.models.fields.CharField')(max_length=10))
    def backwards(self, orm):

        # Changing field 'Comestible.child_model'
        db.alter_column('food_comestible', 'child_model', self.gf('django.db.models.fields.CharField')(max_length=1))
    models = {
        'food.amount': {
        ...
        'food.comestible': {
            ...
            'dishy': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
