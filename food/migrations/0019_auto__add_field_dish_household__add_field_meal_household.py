...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dish.household'
        db.add_column('food_dish', 'household',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='dishes', to=orm['food.Household']),
                      keep_default=False)

        # Adding field 'Meal.household'
        db.add_column('food_meal', 'household',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='meals', to=orm['food.Household']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Dish.household'
        db.delete_column('food_dish', 'household_id')

        # Deleting field 'Meal.household'
        db.delete_column('food_meal', 'household_id')
