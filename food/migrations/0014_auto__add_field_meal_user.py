...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meal.user'
        db.add_column('food_meal', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='meals', to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Meal.user'
        db.delete_column('food_meal', 'user_id')
