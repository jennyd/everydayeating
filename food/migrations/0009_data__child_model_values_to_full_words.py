...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for comestible in orm.Comestible.objects.all():
            if comestible.child_model == 'I':
                comestible.child_model = 'Ingredient'
            else:
                comestible.child_model = 'Dish'
            comestible.save()
    ...
    def backwards(self, orm):
        ...
        for comestible in orm.Comestible.objects.all():
            if comestible.child_model == 'Ingredient':
                comestible.child_model = 'I'
            else:
                comestible.child_model = 'D'
            comestible.save()
