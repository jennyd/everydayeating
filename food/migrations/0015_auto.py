...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cooks on 'Dish'
        db.create_table('food_dish_cooks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dish', models.ForeignKey(orm['food.dish'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('food_dish_cooks', ['dish_id', 'user_id'])

    def backwards(self, orm):
        # Removing M2M table for field cooks on 'Dish'
        db.delete_table('food_dish_cooks')
