...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dish.household'
        db.alter_column('food_dish', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Household']))

        # Changing field 'Meal.household'
        db.alter_column('food_meal', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Household']))
    def backwards(self, orm):

        # Changing field 'Dish.household'
        db.alter_column('food_dish', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Household']))

        # Changing field 'Meal.household'
        db.alter_column('food_meal', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Household']))
    models = {
        'accounts.household': {
        ...
        'food.dish': {
            ...
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dishes'", 'to': "orm['accounts.Household']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'food.meal': {
            ...
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'meals'", 'to': "orm['accounts.Household']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
