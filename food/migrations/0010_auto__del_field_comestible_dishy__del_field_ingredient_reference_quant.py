...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comestible.dishy'
        db.delete_column('food_comestible', 'dishy')

        # Deleting field 'Ingredient.reference_quantity'
        db.delete_column('food_ingredient', 'reference_quantity')

        # Deleting field 'Dish.total_quantity'
        db.delete_column('food_dish', 'total_quantity')

    def backwards(self, orm):
        # Adding field 'Comestible.dishy'
        db.add_column('food_comestible', 'dishy',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Ingredient.reference_quantity'
        db.add_column('food_ingredient', 'reference_quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Dish.total_quantity'
        db.add_column('food_dish', 'total_quantity',
                      self.gf('django.db.models.fields.DecimalField')(default=500, null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'food.comestible': {
            ...
            'child_model': ('django.db.models.fields.CharField', [], {'default': "'Dish'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
