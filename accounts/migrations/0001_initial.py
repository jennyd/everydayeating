...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_household', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='admin_for_set', to=orm['auth.User'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('accounts', ['Household'])

        # Adding model 'Profile'
        db.create_table('accounts_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_profiles', to=orm['accounts.Household'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_household')
